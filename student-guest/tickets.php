					...
					<section id="content-menu" class="content-menu">
						<nav id="menu-wrapper" class="menu-component menu-wrapper">
							...
							<ul class="menu menu-toggle clearfix">
								...
								<li><a href="tickets.php"><div class="menu-item">Tickets</div></a></li>
								<li><a href=""><div class="menu-item">Knowledgebase</div></a></li>
								<li><a href=""><div class="menu-item">Canned Responses</div></a></li>
							</ul>
						</nav>
					</section>
